...
Featurelist = React.createClass({
  features: [
    ...
    {icon:"fa fa-share fa-2x",bigtext:"See what\'s new",littletext:"in your life on your Timeline"},
    ...
    return (
        <div>
          <h2 className="col-md-11 featurelist hidden-xs">
            Connect with friends and the world and the world around you on Fakebook
          </h2>
